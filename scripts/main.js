...
require(['text!templates/index.html!strip'], function (t) {
    ...
    // Handle form.
    $('#cerevoiceCloudForm').submit(function (e) {
        e.preventDefault();
        ...
        var req = 'https://cerevoice.com/rest/rest_1_1.php' + '?text=' + encodeURIComponent(text) + '&voice=' + encodeURIComponent(voice) + '&method=' + encodeURIComponent(method) + '&accountID=' + encodeURIComponent(accountId) + '&password=' + encodeURIComponent(password) + '&audioFormat=' + encodeURIComponent(audioFormat) + '&sampleRate=' + encodeURIComponent(sampleRate) + '&audio3D=' + encodeURIComponent(audio3D) + '&metadata=' + encodeURIComponent(metadata);
